/*!
 * jQuery FocusPoint plugin
 * Author: jonathonmenz.com
 */

//The FocusPoint function
...
;(function( $ ){
	...
	$.fn.focusPoint = function(options) {
		...
		return this.each(function() {
			...
			container.addClass('focus-left-top')
			.removeClass('focus-left-center focus-left-bottom focus-center-top focus-center-center focus-center-bottom focus-right-top focus-right-center focus-right-bottom');
			
			//Adjust now
			container.adjustFocus();
			
			//if (settings.reCalcOnWindowResize) {
				//Calculate each time the window is resized
	...
	$.fn.adjustFocus = function() {
		...
		return this.each(function() {
			...
			if ($wR > $hR) {
				...
				var $focusFactorX = ($(this).data('focus-x')+1)/2;
				...
				//Focus point of resize image in px
				var $focusFactorY = ($(this).data('focus-y')+1)/2;
				//Can't use width() as images may be display:none
				...
				//console.log('focusy'+$focusY+' '+'containerCenterY'+$containerCenterY+' '+'focusOffsetY'+$focusOffsetY);
